...
def get_dealerships(request):
    if request.method == "GET":
        context = {}
        url = "https://us-east.functions.appdomain.cloud/api/v1/web/1380d162-4526-4bd7-b393-721440a6e5b5/dealership-package/get-dealership"
...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://us-east.functions.appdomain.cloud/api/v1/web/1380d162-4526-4bd7-b393-721440a6e5b5/dealership-package/getReview'
...
def add_review(request, dealer_id):
    ...
    if request.user.is_authenticated:
        ...
        if request.method == "GET":
            url = f"https://us-east.functions.appdomain.cloud/api/v1/web/1380d162-4526-4bd7-b393-721440a6e5b5/dealership-package/get-dealership?dealerId={dealer_id}"
